...
export async function createBooking(userId: string, input: CreateBookingInput) {
  ...
  return prisma.booking.create({
    data: { userId, roomId, checkIn, checkOut, guestCount, specialNotes, totalPrice },
  })
}
...
export async function cancelBooking(bookingId: string, requester: { userId: string; role: Role }) {
